...
# survey_waypoints = [
#     airsim.GeoPoint(47.642516883142,  -122.1395677989595, -10),
#     airsim.GeoPoint(47.642186883141996, -122.1395677989595, -10),
#     airsim.GeoPoint(47.642516883142, -122.1425377989595, -10),
#     airsim.GeoPoint(47.642186883141996, -122.1425377989595, -10),
#     airsim.GeoPoint(47.642186883141996, -122.1395677989595, -10),
#     airsim.GeoPoint(47.64185688314199, -122.1395677989595, -10),
#     airsim.GeoPoint(47.641856883142, -122.1425377989595, -10),
# ]

# survey_ned_waypoints = []
# local_waypoints = []
# for waypoint in survey_waypoints:
#     ned_point = airsim.GeoPoint(waypoint.latitude, waypoint.longitude, waypoint.altitude)
#     survey_ned_waypoints.append(ned_point)
#     local_waypoints.append(airsim.Vector3r(waypoint.latitude, waypoint.longitude, waypoint.altitude))
...
class SurveyNavigator:
    ...
    def start(self):
        ...
        print("moving to: " + str(x) + ", " + str(-self.boxsize) + ", " + str(z))
...
#     survey_navigator = SurveyNavigator(args)
#     survey_navigator.start()